    ...
    <div className="trainee-modal-backdrop" onClick={onClose}>
      <div className="trainee-modal-container" onClick={e => e.stopPropagation()}>
        ...
        >
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 14 }}>
            ...
            <div>
              ...
              <strong style={{ color: '#2F5233', display: 'block', fontSize: 14 }}>{course.difficulty}</strong>
            </div>
            <div>
              <small style={{ fontSize: 11, color: '#485563', textTransform: 'uppercase' }}>Certification</small>
              <strong style={{ color: '#2F6B3C', display: 'block', fontSize: 14 }}>Accredited MoES</strong>
            </div>
          </div>

          <div>
            <small style={{ fontSize: 11, color: '#2F5233', fontWeight: 600, display: 'block', marginBottom: 6 }}>
        ...
        <div style={{ marginBottom: 24 }}>
          <strong style={{ fontSize: 13, color: '#485563', display: 'block', marginBottom: 4 }}>
            Expected Learning Outcome
          </strong>
          <p style={{ fontSize: 12.5, color: '#485563', margin: 0, lineHeight: 1.5 }}>
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: 12,
            padding: '32px 28px',
            background: 'linear-gradient(135deg, #16251B 0%, #EEF6EA 100%)',
            textAlign: 'center',
            position: 'relative',
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, marginBottom: 12 }}>
            ...
            <div>
              <div style={{ fontSize: 11, letterSpacing: 2, textTransform: 'uppercase', color: '#485563', fontWeight: 700 }}>
                MINISTRY OF EARTH SCIENCES · GOVERNMENT OF INDIA
              </div>
              <div style={{ fontSize: 14, fontWeight: 800, color: '#2F5233', letterSpacing: 1 }}>
                CAPACITYCONNECT ACCREDITATION BOARD
              </div>
            </div>
          </div>

          <div style={{ width: 120, height: 2, background: 'linear-gradient(90deg, transparent, #2F5233, transparent)', margin: '14px auto 18px' }} />

          <span style={{ fontSize: 12, color: '#485563', textTransform: 'uppercase', letterSpacing: 1.5, fontWeight: 600 }}>
            Certificate of Professional Competency
          </span>

          <p style={{ fontSize: 13, color: '#485563', margin: '12px 0 6px' }}>
          ...
          <p style={{ fontSize: 13, color: '#485563', maxWidth: 520, margin: '0 auto 18px', lineHeight: 1.5 }}>
          ...
          <h3 style={{ fontSize: 20, fontWeight: 800, color: '#2F5233', margin: '0 0 16px' }}>
            {certificate.title}
          </h3>
